...
type User struct {
	...
	AvatarBucket      *string        `json:"-" gorm:"type:varchar(100)"`
	AvatarObjectPath  *string        `json:"-" gorm:"type:varchar(1000)"`
	AvatarContentType *string        `json:"-" gorm:"type:varchar(32)"`
	AvatarFileSize    *int64         `json:"-"`
